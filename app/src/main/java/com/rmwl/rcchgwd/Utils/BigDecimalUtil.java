...
public class BigDecimalUtil {
    ...
    public static String multiply(String v1, String v2) {
        BigDecimal n1 = new BigDecimal(v1);
        BigDecimal n2 = new BigDecimal(v2);
        return n1.multiply(n2).setScale(0,BigDecimal.ROUND_DOWN).toString();
    }
...
//        return n1.divide(n2, 2, BigDecimal.ROUND_HALF_UP).doubleValue();
        return n1.divide(n2, 2, BigDecimal.ROUND_HALF_UP).toPlainString();
    }
     ...
     * @return double
     */
    public static String divideNum(String v1, String v2) {
        BigDecimal n1 = new BigDecimal(v1);
        BigDecimal n2 = new BigDecimal(v2);
        return n1.divide(n2, 2, BigDecimal.ROUND_DOWN).toString();
    }
