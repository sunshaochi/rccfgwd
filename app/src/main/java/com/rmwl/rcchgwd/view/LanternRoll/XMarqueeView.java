package com.rmwl.rcchgwd.view.LanternRoll;
...
public class XMarqueeView extends ViewFlipper {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (typedArray != null) {
            ...
            isSingleLine = typedArray.getBoolean(R.styleable.XMarqueeView_isSingleLine, false);//false
    ...
    public void setData(@LayoutRes int layoutId, List<String> data) {
        ...
        for (int i = 0; i < loopconunt; i++) {
            ...
            if (tvOne != null) {
                ...
                tvOne.setSingleLine(true);
                tvOne.setEllipsize(TextUtils.TruncateAt.END);
            } else {
            ...
            if (tvTwo != null) {
                ...
                tvTwo.setSingleLine(true);
                tvTwo.setEllipsize(TextUtils.TruncateAt.END);
                if (!isSingleLine) {//显示两条时候没有！
